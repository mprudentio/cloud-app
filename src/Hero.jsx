...
const Hero = () => {
  return (
      <div name="home" className='w-full h-[760px] bg-zinc-200 flex flex-col justify-between'>
        <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
            <div className='flex flex-col justify-center md:items-start w-full px-2 py-8 '>
                <br className='sm:hidden'/><br className='sm:hidden'/>
                <p className='text-2xl md:pt-20'>Unique Sequencing and Production</p>
                <h1 className='py-3 text-5xl md:text-7xl font-bold'>Cloud Management</h1>
                <p className='text-2xl'>This is our Tech brand.</p>
                <button className='py-3 px-6 sm:w-[60%] my-4'>Get Started</button>
            </div>
            <div>
               <img className='w-full pt-20' src='./cyber-bg.png' alt="/" />
            </div>
        </div>
        <div className='absolute flex flex-col py-8 md:min-w-[760px] bottom-[-32%] mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200
